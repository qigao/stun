...
public:
  bool init() {
    ...
    auto info = create_infographic(TemplateType::SequenceTimelineSimple);
    info->set_title("Project Timeline");
    info->add_item(DataItem::create("Planning"));
    info->add_item(DataItem::create("Design"));
    info->add_item(DataItem::create("Development"));
    info->add_item(DataItem::create("Testing"));
    info->add_item(DataItem::create("Launch"));

    // Set times
    info->items[0]->time = "Q1";
    info->items[1]->time = "Q2";
    info->items[2]->time = "Q3";
    info->items[3]->time = "Q4";
    info->items[4]->time = "Q1 Next";
