...
public:
  ...
  StateComponentBinding(ObservableState::Ptr state, const std::string &component_name,
...
inline StateComponentBinding::Ptr
create_bound_component(ObservableState::Ptr state, const std::string &component_name,
                       const Props &initial_props,
