...
cssboxSetStyle(line, "x1", "10px");
cssboxSetStyle(line, "y1", "10px");
cssboxSetStyle(line, "x2", "100px");
cssboxSetStyle(line, "y2", "100px");
cssboxSetStyle(line, "stroke", "red");
cssboxSetStyle(line, "stroke-width", "2px");
```
...
cssboxSetStyle(circle, "cx", "50px");
cssboxSetStyle(circle, "cy", "50px");
cssboxSetStyle(circle, "r", "30px");
cssboxSetStyle(circle, "fill", "blue");
cssboxSetStyle(circle, "stroke", "black");
cssboxSetStyle(circle, "stroke-width", "2px");
```
...
cssboxSetStyle(ellipse, "cx", "50px");
cssboxSetStyle(ellipse, "cy", "50px");
cssboxSetStyle(ellipse, "rx", "40px");
cssboxSetStyle(ellipse, "ry", "20px");
cssboxSetStyle(ellipse, "fill", "green");
```
...
cssboxSetStyle(rect, "x", "10px");
cssboxSetStyle(rect, "y", "10px");
cssboxSetStyle(rect, "width", "100px");
cssboxSetStyle(rect, "height", "50px");
cssboxSetStyle(rect, "fill", "purple");
cssboxSetStyle(rect, "border-radius", "5px");
```
...
cssboxSetStyle(path, "stroke", "black");
cssboxSetStyle(path, "stroke-width", "3px");
```
...
**File:** `cssbox/src/cssbox_painter.cpp`
...
auto circle = cssboxCreateElement(renderer, "c1", "circle");
cssboxAddClass(circle, "circle");
```
...
auto line = cssboxCreateElement(renderer, "line1", "line");
cssboxSetStyle(line, "x1", "10px");
cssboxSetStyle(line, "y1", "50px");
cssboxSetStyle(line, "x2", "200px");
cssboxSetStyle(line, "y2", "50px");
cssboxSetStyle(line, "stroke", "black");
cssboxSetStyle(line, "stroke-width", "2px");
cssboxSetStyle(line, "stroke-dasharray", "10 5");
```

### Hand-Drawn Path

```cpp
auto path = cssboxCreateElement(renderer, "sketch", "path");
...
**Implementation:** ~800 lines in `cssbox_painter.cpp`  
