/*
    src/screen_glfw.cpp -- Top-level widget and interface between NanoGUI and GLFW
...
Screen::Screen(const Vector2i &size, std::string_view caption, bool resizable, bool maximized,
  ...
  #if (defined(NANOGUI_USE_OPENGL) || defined(NANOGUI_USE_GLES) || defined(NANOGUI_USE_METAL)) &&  \
