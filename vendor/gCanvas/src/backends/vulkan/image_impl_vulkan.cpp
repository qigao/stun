...
namespace gcanvas
{
    ...
    ImageImplVulkan::ImageImplVulkan(int width, int height, int components,
    ...
    ImageImplVulkan::~ImageImplVulkan()
    {
        ...
        VmaAllocator allocator = VulkanSharedInfo::getInstance()->allocator;
    ...
    void ImageImplVulkan::upload(const VkCommandPool& commandPool, const VkQueue& queue)
    {
        ...
        void* rawData;
        vku::err_check(vmaMapMemory(allocator, _stagingAllocation, &rawData));
        ...
        vku::err_check(vmaCreateImage(allocator, &imageCreateInfo, &allocationCreateInfo, &_image,
                                      &_allocation, nullptr));
