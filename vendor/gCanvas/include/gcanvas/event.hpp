#ifndef GCANVAS_EVENT_HPP
#define GCANVAS_EVENT_HPP
...
namespace gcanvas
{
    ...
    struct GCANVAS_API scroll_event
    {
        double xoffset;
        double yoffset;
    };
    ...
    struct GCANVAS_API mouse_button_event
    {
        mouse_button button;
        input_action action;
        mouse_mod mods;
