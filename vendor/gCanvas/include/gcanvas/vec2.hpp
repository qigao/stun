#ifndef GCANVAS_VEC2_HPP
#define GCANVAS_VEC2_HPP
...
namespace gcanvas
{
    ...
    public:
        ...
        friend GCANVAS_API std::ostream& operator<<(std::ostream& os, vec2 m);
