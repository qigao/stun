%name ErrorbandChartParser
%token_prefix ERRORBAND_
...
%syntax_error {
    ...
    if (ctx->error_message.empty()) {
        ctx->error_message = "errorband: syntax error";
    }
}

start ::= ERRORBAND LBRACE body RBRACE.
start ::= ERRORBAND LBRACE RBRACE.
