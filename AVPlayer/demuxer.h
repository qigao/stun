...
public:
	...
	/**
	 * \brief Gets the duration of the video stream in seconds
	...
	/**
	 * \brief Gets the format context (for subtitle track enumeration)
	 * \return Pointer to AVFormatContext
	 */
	void* format_context() const { return format_context_; }
