...
struct LayoutNode {
    ...
    LayoutNode(NVGCSSElement* elem = nullptr)
...
public:
    ...
    LayoutNode* build_tree(NVGCSSElement* root, NVGCSSRenderer* renderer);
    
    // Compute layout (three-phase algorithm)
    void compute_layout(LayoutNode* root, NVGCSSRenderer* renderer);
...
private:
    ...
    void calculate_dimensions(LayoutNode* node, NVGCSSRenderer* renderer);
    ...
    void calculate_block_dimensions(LayoutNode* node, NVGCSSRenderer* renderer);
    void calculate_flex_dimensions(LayoutNode* node, NVGCSSRenderer* renderer);
    ...
    void calculate_grid_dimensions(LayoutNode* node, NVGCSSRenderer* renderer);
