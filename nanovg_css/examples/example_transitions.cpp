...
private:
    ...
    NVGCSSElement* color_box = nullptr;
    NVGCSSElement* scale_box = nullptr;
    NVGCSSElement* fade_box = nullptr;
    NVGCSSElement* rotate_box = nullptr;
    NVGCSSElement* multi_box = nullptr;
    NVGCSSElement* position_box = nullptr;
    NVGCSSElement* fast_box = nullptr;
    NVGCSSElement* slow_box = nullptr;
    ...
    NVGCSSElement* create_box(const char* id) {
        auto* box = nvgcssCreateElement(renderer, id, "div");
        nvgcssAddClass(box, "box");
        return box;
    }
    ...
    void update_hover(NVGCSSElement* elem, float mx, float my, float x, float y, float w, float h) {
        if (!elem) return;
