 ...
 * @brief Test memory pool integration in nanovg_css
 */
...
void test_transition_state_allocation() {
    ...
    NVGCSSElement* elem1 = nvgcssCreateElement(renderer, "elem1", "div");
    NVGCSSElement* elem2 = nvgcssCreateElement(renderer, "elem2", "div");
    NVGCSSElement* elem3 = nvgcssCreateElement(renderer, "elem3", "div");
    ...
    nvgcssUpdate(renderer, 0.016f);  // 16ms frame
...
void test_animation_state_allocation() {
    ...
    nvgcssParseCSS(renderer, keyframes_css);
    
    // Create element with animation
    NVGCSSElement* elem = nvgcssCreateElement(renderer, "animated", "div");
...
void test_memory_reuse() {
    ...
    for (int i = 0; i < 5; i++) {
        ...
        NVGCSSElement* elem = nvgcssCreateElement(renderer, id, "div");
...
int main() {
    std::cout << "nanovg_css Memory Pool Integration Tests\n";
    std::cout << "==========================================\n\n";
