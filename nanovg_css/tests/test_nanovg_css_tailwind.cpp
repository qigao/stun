...
TEST_CASE("Tailwind - CSS Variable Resolution", "[tailwind][variables]") {
    ...
    SECTION("Resolve simple color variable") {
        ...
        NVGCSSElement* el = nvgcssCreateElement(renderer, "test", "div");
    ...
    SECTION("REGRESSION: --white variable resolution") {
        ...
        NVGCSSElement* white_el = nvgcssCreateElement(renderer, "white", "div");
        white_el->classes.push_back("text-white");

        NVGCSSElement* black_el = nvgcssCreateElement(renderer, "black", "div");
    ...
    SECTION("Multiple variables in same element") {
        ...
        NVGCSSElement* el = nvgcssCreateElement(renderer, "test", "button");
    ...
    SECTION("Tailwind color palette variables") {
        ...
        auto test_color = [&](const char* class_name, const char* expected_color) {
            NVGCSSElement* el = nvgcssCreateElement(renderer, class_name, "div");
...
TEST_CASE("Tailwind - Atomic Utility Classes", "[tailwind][utilities]") {
    ...
    SECTION("Width utilities (w-*)") {
        ...
        NVGCSSElement* el20 = nvgcssCreateElement(renderer, "el20", "div");
        el20->classes.push_back("w-20");

        NVGCSSElement* el24 = nvgcssCreateElement(renderer, "el24", "div");
        el24->classes.push_back("w-24");

        NVGCSSElement* el32 = nvgcssCreateElement(renderer, "el32", "div");
    ...
    SECTION("Height utilities (h-*)") {
        ...
        NVGCSSElement* el8 = nvgcssCreateElement(renderer, "el8", "div");
        el8->classes.push_back("h-8");

        NVGCSSElement* el10 = nvgcssCreateElement(renderer, "el10", "div");
        el10->classes.push_back("h-10");

        NVGCSSElement* el12 = nvgcssCreateElement(renderer, "el12", "div");
    ...
    SECTION("Padding utilities (px-*, py-*)") {
        ...
        NVGCSSElement* el = nvgcssCreateElement(renderer, "el", "div");
...
TEST_CASE("Tailwind - Complete Button Component", "[tailwind][integration][button]") {
    ...
    SECTION("Primary button with multiple utilities") {
        ...
        NVGCSSElement* button = nvgcssCreateElement(renderer, "btn-primary", "button");
    ...
    SECTION("Semantic color buttons") {
        ...
        NVGCSSElement* success = nvgcssCreateElement(renderer, "btn-success", "button");
        success->classes = {"bg-green-500", "text-white", "w-24", "h-10"};

        NVGCSSElement* warning = nvgcssCreateElement(renderer, "btn-warning", "button");
        warning->classes = {"bg-yellow-500", "text-white", "w-24", "h-10"};

        NVGCSSElement* danger = nvgcssCreateElement(renderer, "btn-danger", "button");
...
TEST_CASE("Tailwind - Pseudo-class Variants", "[tailwind][pseudo-class]") {
    ...
    SECTION("Hover state styling") {
        ...
        NVGCSSElement* button = nvgcssCreateElement(renderer, "btn", "button");
...
TEST_CASE("Tailwind - Responsive Breakpoints", "[tailwind][responsive]") {
    ...
    SECTION("Mobile-first responsive width") {
        ...
        NVGCSSElement* box = nvgcssCreateElement(renderer, "box", "div");
...
TEST_CASE("Tailwind - Real-world Components", "[tailwind][integration][real-world]") {
    ...
    SECTION("Complete Card Component") {
        ...
        // Card container
        NVGCSSElement* card = nvgcssCreateElement(renderer, "card", "div");
        card->classes = {"bg-white", "p-6", "rounded-lg", "shadow-lg"};

        // Card title
        NVGCSSElement* title = nvgcssCreateElement(renderer, "title", "h2");
        title->classes = {"text-gray-800", "mb-4"};

        // Card link
        NVGCSSElement* link = nvgcssCreateElement(renderer, "link", "a");
    ...
    SECTION("Complete Form Input Component") {
        ...
        NVGCSSElement* input = nvgcssCreateElement(renderer, "email", "input");
...
TEST_CASE("Tailwind - Performance Stress Test", "[tailwind][performance]") {
    ...
    SECTION("Many elements with many classes") {
        ...
        std::vector<NVGCSSElement*> elements;
        for (int i = 0; i < 100; i++) {
            std::string id = "el_" + std::to_string(i);
            NVGCSSElement* el = nvgcssCreateElement(renderer, id.c_str(), "div");
