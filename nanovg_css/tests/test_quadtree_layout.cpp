...
void test_single_element() {
    ...
    // Create root element
    NVGCSSElement* root = new NVGCSSElement();
    root->id = "root";
...
void test_parent_child_fixed() {
    ...
    NVGCSSElement* child = new NVGCSSElement();
    child->id = "child";
...
void test_flex_row_simple() {
    ...
    NVGCSSElement* container = new NVGCSSElement();
...
void test_nested_flex() {
    ...
    NVGCSSElement* outer = new NVGCSSElement();
    outer->id = "outer";
    ...
    // Inner container (row)
    NVGCSSElement* inner = new NVGCSSElement();
    inner->id = "inner";
