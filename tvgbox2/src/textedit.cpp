...
#define STB_TEXTEDIT_STRING           tvgbox2::TextEditString
...
static int tvgbox2_textedit_delete(tvgbox2::TextEditString* obj, int i, int n) {
...
#define STB_TEXTEDIT_DELETECHARS(obj, i, n) \
    tvgbox2_textedit_delete(obj, i, n)

// Insert n characters at position i
static int tvgbox2_textedit_insert(tvgbox2::TextEditString* obj, int i, const char* text, int n) {
...
#define STB_TEXTEDIT_INSERTCHARS(obj, i, text, n) \
    tvgbox2_textedit_insert(obj, i, text, n)
...
int map_key_to_stb(int key, bool shift, bool ctrl) {
  ...
  // These match tvgbox2::KeyCode values from event.h (GLFW style)
