...
public:
    ...
    void draw(flex::Renderer& r, const Transform& parent, float alpha) override {
        ...
        char path[128];
        snprintf(path, sizeof(path), "M %.4g %.4g L %.4g %.4g", x_, y_, x2_, y2_);
