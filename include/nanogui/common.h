...
/// Backend-agnostic mouse button constants (compatible with both GLFW and SDL2)
/// These values match GLFW constants and are mapped by SDL2 backend
constexpr int NANOGUI_MOUSE_BUTTON_LEFT = 0;    ///< Left mouse button
constexpr int NANOGUI_MOUSE_BUTTON_RIGHT = 1;   ///< Right mouse button
constexpr int NANOGUI_MOUSE_BUTTON_MIDDLE = 2;  ///< Middle mouse button
constexpr int NANOGUI_MOUSE_BUTTON_1 = 0;       ///< Alias for left button
constexpr int NANOGUI_MOUSE_BUTTON_2 = 1;       ///< Alias for right button
constexpr int NANOGUI_MOUSE_BUTTON_3 = 2;       ///< Alias for middle button
