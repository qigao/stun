...
int main() {
    flexui::Screen screen(500, 400, "JavaScript Module Demo");
    ...
    screen.loadXML(R"(
        <div id="main-panel">
            <label id="title">JavaScript Module Demo</label>
    ...
    // Load ES6 module - this will automatically load counter.js and timer.js
    screen.loadJSModule("js_modules/main.js");
